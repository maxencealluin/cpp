...
/*   Updated: 2020/01/16 15:54:33 by malluin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
_name(name), _grade_sign(sgrade), _grade_exec(egrade), _signed(false), _target(target)
{
	if (this->_grade_sign < 1 || this->_grade_exec < 1)
		throw(Form::GradeTooHighException());
	if (this->_grade_sign > 150 || this->_grade_exec > 150)
...
Form::NotSignedException::NotSignedException(NotSignedException const & instance)
{
	*this = instance;
}
